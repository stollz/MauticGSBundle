<?php
namespace MauticPlugin\MauticGSBundle\Google\google_api_php_client\src\Google\Logger;
/*
...
abstract class Google_Logger_Abstract
{
  ...
  {
    $this->setLevel(
        $client->getClassConfig('MauticPlugin\MauticGSBundle\Google\google_api_php_client\src\Google\Logger\Google_Logger_Abstract', 'level')
    );

    $format = $client->getClassConfig('MauticPlugin\MauticGSBundle\Google\google_api_php_client\src\Google\Logger\Google_Logger_Abstract', 'log_format');
    $this->logFormat = $format ? $format : self::DEFAULT_LOG_FORMAT;

    $format = $client->getClassConfig('MauticPlugin\MauticGSBundle\Google\google_api_php_client\src\Google\Logger\Google_Logger_Abstract', 'date_format');
    $this->dateFormat = $format ? $format : self::DEFAULT_DATE_FORMAT;

    $this->allowNewLines = (bool) $client->getClassConfig(
        'MauticPlugin\MauticGSBundle\Google\google_api_php_client\src\Google\Logger\Google_Logger_Abstract',
        'allow_newlines'
    );
  }
